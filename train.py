...
def parse_args():
    ...
    parser.add_argument('--data-dir', default='E:/code/DataSets/RGBT/RGBT-CC-A-use',
    ...
    parser.add_argument('--pretrained_model',
                        default=r'./models/best_model_10.762619034647942.pth', type=str,
    ...
    parser.add_argument('--val_start', type=int, default=4,
